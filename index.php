   ...
   <div class="site-container">
      ...
      <main>
         ...
         <div class="forms-background" id="forms-background">
            ...
            <form class="form form__login" id="login-form" method="post" autocomplete="off">
               <h3 class="form__title orange-text">Войти в аккаунт</h3>
               <div class="form__input">
                  <input name="login" id="login" type="text" class="form__field" autocomplete="off" required />
                  <label class="form__label">Введите логин</label>
               </div>
               <div class="alert">Только английские буквы, точка и нижнее подчеркивание. <br> Поле должно быть заполнено</div>
               ...
               <div class="alert">Поле должно быть заполнено, минимальное количество символов - 8</div>
            ...
            <form class="form form__register" id="register-form" method="post">
               <h3 class="form__title orange-text">Зарегистрироваться</h3>

               <div class="form__input">
                  <input name="name" id="name" type="text" class="form__field" autocomplete="off" required />
               ...
               <div class="form__input">
                  <input name="login" id="reg-login" type="text" class="form__field" autocomplete="off" required />
                  <label class="form__label">Введите логин</label>
               </div>
               ...
               <div class="form__input">
                  <input name="email" id="email" type="text" class="form__field" autocomplete="off" required />
               ...
               <div class="form__input">
                  <input name="password_conf" id="password-conf" type="password" class="form__field" autocomplete="off"
                     required />
                  <label class="form__label">Повторите ваш пароль</label>
               </div>
               <div class="alert">Пароли должны совпадать. <br> Поле должно быть заполнено</div>
